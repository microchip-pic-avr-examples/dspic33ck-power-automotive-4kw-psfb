...
#else
    // primary PIC 16 adc ref = 4.096, k = 4,32mv
    // secondary dspic adc ref = 3.3, 
    // 3.3/4.32 = 0,805, k´ = k * 0,805 => 3,8mv
    #define VPRI_SNS_GAIN               (float)(3.48e-3)   // V/V  
    #define VPRI_SNS_OFS                (0.165)   // V
#endif
...
#define VSEC_SNS_GAIN               (154e-3)   // V/V
/** @} */ // end of group ~~~~~~~~~~~~~~~~~~~~
...
// #define ISEC_CT_SNS_OFS             (0.5)     // V

// ISEC_AVG_SNS = ISEC_AVG * ISEC_AVG_SNS_GAIN + ISEC_AVG_SNS_OFS
#define ISEC_AVG_SNS_GAIN           (10.0e-3)   // V/A
#define ISEC_AVG_SNS_OFS            (0.5)      // V
/** @} */ // end of group ~~~~~~~~~~~~~~~~~~~~
 ...
 * @{
 ******************************************************************************/
#define TEMPERATURE_GAIN           (0.0196)       
